...
{
    public partial class UserControlZupy : UserControl
    {
        public UserControlZupy()
        {
            InitializeComponent();
        }
        ...
        private void btnDodajDoKoszyka_Click(object sender, EventArgs e)
        {
            ...
            {
                ListViewItem prod = new ListViewItem(listViewZupy.SelectedItems[0].Text);
                prod.SubItems.Add(x.ToString());
                int cena = int.Parse(listViewZupy.SelectedItems[0].SubItems[1].Text);
